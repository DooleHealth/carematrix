          ...
          value: function acceptLegalConditions() {
            ...
            Storage.get({
              ...
              if (showIntro) {
                ...
                _this.router.navigate(['/home/initial']);
              } else {
