  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["report-problem-report-problem-module"], {
    ...
    function mH(module, __webpack_exports__, __webpack_require__) {
      ...
      var ReportProblemPage = /*#__PURE__*/function () {
        function ReportProblemPage(translate, router, dooleService, chooser, sanitizer, fb, platform, file, loadingController, alertController) {
        ...
        _createClass(ReportProblemPage, [{
                    ...
                    case 2:
                      ...
                      if (image) {
                        ...
                        this.saveBase64(fileUri, filename.toString()).then(function (file) {
                          ...
                          _this2.numFile = _this2.patient_files.length;
                        });
                      }
          ...
          value: function removeFile(name) {
            ...
            this.patient_files.forEach(function (element, index) {
              if (element.name == name) _this3.patient_files.splice(index, 1);
            });
            this.numFile = this.patient_files.length;
          }
        }, {
                      ...
                      return this.alertController.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            ...
                            _this6.router.navigateByUrl('/profile');
                          }
                        }],
                  ...
                  switch (_context11.prev = _context11.next) {
                    case 0:
                      this.dooleService.uploadFile(data).then(function (res) {
                        ...
                        if (isSuccess) _this7.presentAlert(_this7.translate.instant("report_problem.alert_successful_response"));else _this7.presentAlert(_this7.translate.instant("report_problem.alert_no_successful_response"));
                      })["catch"](function (err) {
                        console.log("Error uploadFile: ", err);

                        _this7.presentAlert(err);
                  ...
                  switch (_context12.prev = _context12.next) {
                    case 0:
                      ...
                      this.saveBase64(fileUri, filename.toString()).then(function (res) {
                        ...
                        _this8.dooleService.uploadFile(res).then(function (data) {
                          console.log("savePicture() uploadFile res: ", res);

                          _this8.mediaFiles.push(data);

                          _this8.imagesTemp.push(data);

                          console.log("savePicture() this.mediafiles.: ", _this8.mediaFiles); //loading.dismiss();
                        })["catch"](function (err) {
          ...
          value: function saveBase64(base64, name) {
            ...
            return new Promise(function (resolve, reject) {
              ...
              var blob = _this9.b64toBlob(realData, 'image/jpeg');

              _this9.file.writeFile(_this9.file.cacheDirectory, name, blob).then(function () {
                resolve(_this9.file.cacheDirectory + name);
              })["catch"](function (err) {
                console.log(err);
