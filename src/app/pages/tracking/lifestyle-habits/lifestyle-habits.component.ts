...
export class LifestyleHabitsComponent  implements OnInit {
  ...
  {img: 'assets/images/shared-care-plan/news.png', title: 'News', description: 'Stay up to date and informed', type: NotificationsType.NEWS},
  {img: 'assets/images/shared-care-plan/advices.png', title: 'Advices', description: 'Health recommendations', type: NotificationsType.ADVICES},
  {img: 'assets/images/shared-care-plan/exercices.png', title: 'Exercices', description: 'Experiences similar to yours', type:NotificationsType.EXERCISES},
  {img: 'assets/images/shared-care-plan/games.png', title: 'Games', description: 'Experiences similar to yours', type:NotificationsType.GAMES},
  {img: 'assets/images/shared-care-plan/diets.png', title: 'Diets', description: 'Improve your diet', type:NotificationsType.DIETS},
