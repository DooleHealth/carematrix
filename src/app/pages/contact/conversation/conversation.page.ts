      ...
      this.dooleService.getAPImessage(this.id, params).subscribe(
        async (res: any) => {
          ...
          if (res.success) {
            ...
            if (res.specialities && Array.isArray(res.specialities)) {
              this.specialityNames = res.specialities.flatMap(specialityArray =>
                specialityArray.map(speciality => speciality.name)
              );
            } else {
              this.specialityNames = [];
            }
